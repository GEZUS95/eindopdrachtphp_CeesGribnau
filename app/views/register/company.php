...
<?php $this->sesHelp->message(); ?>
    <div class="wrapper">
        <form method="post" action="">
            ...
            <div class="form-group">
                <button type="submit" name="company-btn-submit" class="btn btn-primary btn-lg">Register</button>
            </div>
            <p>Are you a user? <a href="/register">Register Here!</a></p>
        </form>
